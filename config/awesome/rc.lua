...
beautiful.init("/home/wmoore/.config/awesome/theme.lua")
...
local mytextclock = wibox.widget.textclock(" %a %-e %b, %-I:%M %p ")
...
awful.screen.connect_for_each_screen(function(s)
    ...
    awful.tag.add("9", { layout = awful.layout.suit.floating, screen = s})
    ...
    -- Spawn bar info
    local bar_path = "/home/wmoore/Projects/bar/target/release/bar -a -b -w"
...
globalkeys = gears.table.join(
    ...
    -- Standard program
    awful.key({ modkey,           }, "Return", function () awful.spawn(terminal .. " msg create-window") end,
